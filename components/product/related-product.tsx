...
export const RelatedProductList: React.FC<{ category: string }> = ({ category }) => {
    const { data: list, isLoading } = useFetch<ProductCardProps[]>({
        id: "products", params: {
            "populate": "*", "filters[category][uid][$in]": category
        }, keySuffix: "related-product", cb: formateData
    });
